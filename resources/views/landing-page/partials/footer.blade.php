<footer class="section-t-space">
    <div class="container-fluid-lg">
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="footer-logo">
                        <div class="theme-logo">
                            <a href="index.html">
                                <img src="{{ url('landing-page') }}/assets/images/logo/1.png" class="blur-up lazyload"
                                    alt="">
                            </a>
                        </div>
                                ...
                                <ul>
                                    <li class="mb-0">
                                        <a href="https://play.google.com/store/apps" target="_blank">
                                            <img src="{{ url('landing-page') }}/assets/images/playstore.svg"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                    </li>
                                    <li class="mb-0">
                                        <a href="https://www.apple.com/in/app-store/" target="_blank">
                                            <img src="{{ url('landing-page') }}/assets/images/appstore.svg"
                                                class="blur-up lazyload" alt="">
                                        </a>
                                    </li>
                                </ul>
        ...
        <div class="sub-footer section-small-space">
            ...
            <div class="payment">
                <img src="{{ url('landing-page') }}/assets/images/payment/1.png" class="blur-up lazyload"
                    alt="">
            </div>
