                        ...
                        <li class="right-nav-list">
                            <div class="dropdown theme-form-select">
                                <button class="btn dropdown-toggle" type="button" id="select-language"
                                    ...
                                    <img src="{{ url('landing-page') }}/assets/images/country/united-states.png"
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="select-language">
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="english">
                                            <img src="{{ url('landing-page') }}/assets/images/country/united-kingdom.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                            <span>English</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="france">
                                            <img src="{{ url('landing-page') }}/assets/images/country/germany.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                            <span>Germany</span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item" href="javascript:void(0)" id="chinese">
                                            <img src="{{ url('landing-page') }}/assets/images/country/turkish.png"
                                                class="img-fluid blur-up lazyload" alt="">
                                            <span>Turki</span>
                                        </a>
                                    </li>
                ...
                <div class="col-12">
                    <div class="navbar-top">
                        ...
                        <a href="index.html" class="web-logo nav-logo">
                            <img src="{{ url('landing-page') }}/assets/images/logo/1.png"
                                class="img-fluid blur-up lazyload" alt="">
                        </a>
                                        ...
                                        <div class="onhover-div">
                                            <ul class="cart-list">
                                                <li class="product-box-contain">
                                                    <div class="drop-cart">
                                                        <a href="product-left-thumbnail.html" class="drop-image">
                                                            <img src="{{ url('landing-page') }}/assets/images/vegetable/product/1.png"
                                                ...
                                                <li class="product-box-contain">
                                                    <div class="drop-cart">
                                                        <a href="product-left-thumbnail.html" class="drop-image">
                                                            <img src="{{ url('landing-page') }}/assets/images/vegetable/product/2.png"
                                                                class="blur-up lazyload" alt="">
                                                        </a>
                            ...
                            <ul class="category-list">
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{ url('landing-page') }}/assets/svg/1/vegetable.svg"
                                            alt="">
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{ url('landing-page') }}/assets/svg/1/cup.svg" alt="">
                                        <h6>Beverages</h6>
                                        <i class="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{ url('landing-page') }}/assets/svg/1/meats.svg" alt="">
                                        <h6>Meats & Seafood</h6>
                                        <i class="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{ url('landing-page') }}/assets/svg/1/breakfast.svg"
                                            alt="">
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{ url('landing-page') }}/assets/svg/1/frozen.svg" alt="">
                                        <h6>Frozen Foods</h6>
                                        <i class="fa-solid fa-angle-right"></i>
                                    </a>
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{ url('landing-page') }}/assets/svg/1/biscuit.svg" alt="">
                                ...
                                <li class="onhover-category-list">
                                    <a href="javascript:void(0)" class="category-name">
                                        <img src="{{ url('landing-page') }}/assets/svg/1/grocery.svg" alt="">
