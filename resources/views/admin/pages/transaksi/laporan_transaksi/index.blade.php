            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive mb-12">
                        <form action="{{ url('/admin/transaksi/laporan/transaksi/filterByStatus') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <div class="row">
                                    <label class="control-label col-sm-1" style="margin-top: 5px;"> Filter : </label>
                                    <div class="col-md-3">
                                        <select name="filterBayar" class="form-control select2 form-select"
                                            data-placeholder="Pilih" id="filterBayar" required>
