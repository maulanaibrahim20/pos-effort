            ...
            <div class="col-xl-4 col-md-6 col-12">
                <div class="card card-congratulation-medal">
                    <div class="card-body">
                        ...
                        <img src="{{ url('app-assets') }}/images/illustration/badge.svg" class="congratulation-medal"
                            alt="Medal Pic" />
                    </div>
                </div>
            </div>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ url('app-assets') }}/images/icons/toolbox.svg"
                                                            alt="Toolbar svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ url('app-assets') }}/images/icons/parachute.svg"
                                                            alt="Parachute svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ url('app-assets') }}/images/icons/brush.svg"
                                                            alt="Brush svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ url('app-assets') }}/images/icons/star.svg"
                                                            alt="Star svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ url('app-assets') }}/images/icons/book.svg"
                                                            alt="Book svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ url('app-assets') }}/images/icons/rocket.svg"
                                                            alt="Rocket svg" />
                                                    </div>
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="avatar rounded">
                                                    <div class="avatar-content">
                                                        <img src="{{ url('app-assets') }}/images/icons/speaker.svg"
                                                            alt="Speaker svg" />
                                                    </div>
                                                </div>
                                                <div>
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card card-developer-meetup">
                    <div class="meetup-img-wrapper rounded-top text-center">
                        <img src="{{ url('app-assets') }}/images/illustration/email.svg" alt="Meeting Pic"
                            height="170" />
                    </div>
                    <div class="card-body">
                        ...
                        <div class="avatar-group">
                            <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"
                                ...
                                <img src="{{ url('app-assets') }}/images/portrait/small/avatar-s-9.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"
                                title="Amy Carson" class="avatar pull-up">
                                <img src="{{ url('app-assets') }}/images/portrait/small/avatar-s-6.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"
                                title="Brandon Miles" class="avatar pull-up">
                                <img src="{{ url('app-assets') }}/images/portrait/small/avatar-s-8.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"
                                title="Daisy Weber" class="avatar pull-up">
                                <img src="{{ url('app-assets') }}/images/portrait/small/avatar-s-20.jpg" alt="Avatar"
                                    width="33" height="33" />
                            </div>
                            <div data-bs-toggle="tooltip" data-popup="tooltip-custom" data-bs-placement="bottom"
                ...
                <div class="card card-browser-states">
                    ...
                    <div class="card-body">
                        <div class="browser-states">
                            <div class="d-flex">
                                <img src="{{ url('app-assets') }}/images/icons/google-chrome.png" class="rounded me-1"
                        ...
                        <div class="browser-states">
                            <div class="d-flex">
                                <img src="{{ url('app-assets') }}/images/icons/mozila-firefox.png" class="rounded me-1"
                        ...
                        <div class="browser-states">
                            <div class="d-flex">
                                <img src="{{ url('app-assets') }}/images/icons/apple-safari.png" class="rounded me-1"
                        ...
                        <div class="browser-states">
                            <div class="d-flex">
                                <img src="{{ url('app-assets') }}/images/icons/internet-explorer.png"
                        ...
                        <div class="browser-states">
                            <div class="d-flex">
                                <img src="{{ url('app-assets') }}/images/icons/opera.png" class="rounded me-1"
