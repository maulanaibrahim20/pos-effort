    ...
    <div class="row row-deck">
        <div class="col-lg-6 col-md-">
            <div class="card custom-card">
                ...
                <form action="{{ url('super_admin/master/kategori') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                    <div class="card-body">
                        @if (session('error'))
                        ...
                        <div class="d-flex flex-column">
                            <div class="form-group">
                                <input class="form-control" placeholder="Masukan Nama Kategori" name="nama"
                                    type="text">
                            </div>
                        </div>
